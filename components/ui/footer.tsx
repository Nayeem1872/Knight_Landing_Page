        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              ...
              <p>Email: <a href="mailto:info@example.com" className="text-teal-500 hover:text-gray-100 transition duration-150 ease-in-out">info@example.com</a></p>
              <p>Phone: <a href="tel:+1234567890" className="text-teal-500 hover:text-gray-100 transition duration-150 ease-in-out">+123 456 7890</a></p>
            </div>
